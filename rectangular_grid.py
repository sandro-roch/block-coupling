...
# Change this value for different values of k.
k = 4
...
# being approached without the need running the process till it terminates. However, for the proof in our article we
# only use the final result value.
